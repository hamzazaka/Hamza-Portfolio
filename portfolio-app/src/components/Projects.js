        ...
        <div id='Projects' className='project-page'>
            ...
            <div className="row">
               ...
               <div className="row">
                ...
                <div className="col-md-6 project-description pd-2">
                    ...
                    <a rel="noreferrer noopener" target='_blank' href="https://admin-dashboardbyreact.netlify.app/" className='btn btn-contact'>Live </a>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-6 project-description pd-2">
                    ...
                    <a rel="noreferrer noopener" target='_blank' href="https://hamzaportfolio.netlify.app/" className='btn btn-contact'>Live </a>
                </div>
